...
const BecomeSeller = () => {
  ...
  const [shopType, setShopType] = useState(""); // blank initially
  const [shopPhoto, setShopPhoto] = useState(null); // ✅ file
...
const handleBecomeSeller = async (e) => {
  ...
  try {
    ...
    formData.append("shopImage", shopPhoto); // ✅ match backend
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="w-full max-w-md bg-white p-6 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleBecomeSeller} className="space-y-4" encType="multipart/form-data">
          <input
            type="text"
